...
const LoginRegister = () => {
  ...
  const normalizeAuthError = (message, mode) => {
    ...
    if (lower.includes('reset token')) {
      return 'Reset token is invalid or expired. Request a fresh link.';
    }
  ...
  const handleChange = (e) => {
    ...
    if (name === 'institutionId' && !/^\d*$/.test(value)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(normalizeAuthError(err.message, isLogin ? 'login' : 'register'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      setError(normalizeAuthError(err.message, 'login'));
    } finally {
  ...
  const handleDirectResetPassword = async (e) => {
    ...
    try {
      ...
      setSuccess(response?.message || 'Password reset successful. Please login.');
      setShowResetForm(false);
      setResetToken('');
      setResetNewPassword('');
      setResetConfirmPassword('');
      ...
      <div className="auth-container">
        ...
        <div className="auth-box">
          ...
          {isLogin && showForgotPassword && (
            <form className="auth-form auth-subform" onSubmit={handleForgotPassword}>
              <div className="form-group">
          ...
          {isLogin && showResetForm && (
            <form className="auth-form auth-subform" onSubmit={handleDirectResetPassword}>
              <div className="form-group">
